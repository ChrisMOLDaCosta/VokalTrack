// src/screens/BookmarkScreen.jsx
...
import { Plus, Trash2, BookOpen, Heart } from 'lucide-react-native';
...
export default function BookmarkScreen() {
  const [bookmarks, setBookmarks] = useState(
    LatihanList.filter(item => item.id % 2 === 0)
  );
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptySubText}>
            Tandai latihan favoritmu dari halaman Latihan
          </Text>
        </View>
      </SafeAreaView>
    );
...
const styles = StyleSheet.create({
  ...
  deleteButton: {
    ...
    bottom: 12,
    right: 12,
    backgroundColor: colors.white(0.95),
    padding: 8,
    borderRadius: 20,
    zIndex: 10,
    shadowColor: '#000',
