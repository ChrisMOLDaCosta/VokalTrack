      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.container}>
            <View>
              ...
              <View style={styles.form}>
                ...
                <View style={styles.inputContainer}>
                  <TextInput style={styles.input} placeholder="Email Anda" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
                </View>
            ...
            <View style={{ gap: 10 }}>
              <TouchableOpacity style={[styles.button, { backgroundColor: isLoginDisabled ? colors.blue(0.5) : colors.blue() }]} onPress={handleLogin} disabled={isLoginDisabled}>
